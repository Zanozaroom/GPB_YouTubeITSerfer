 ...
 */
public abstract class Hilt_YTVideoListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_YTVideoListFragment() {
    super();
  }

  Hilt_YTVideoListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((YTVideoListFragment_GeneratedInjector) this.generatedComponent()).injectYTVideoListFragment(UnsafeCasts.<YTVideoListFragment>unsafeCast(this));
    }
  }
