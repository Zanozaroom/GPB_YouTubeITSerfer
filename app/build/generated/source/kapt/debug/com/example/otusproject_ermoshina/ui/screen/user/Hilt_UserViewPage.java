 ...
 */
public abstract class Hilt_UserViewPage extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserViewPage(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserViewPage_GeneratedInjector) this.generatedComponent()).injectUserViewPage(UnsafeCasts.<UserViewPage>unsafeCast(this));
    }
  }
