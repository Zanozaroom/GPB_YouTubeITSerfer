 ...
 */
public abstract class Hilt_UserPlayListFragment extends BasePLFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserPlayListFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectUserPlayListFragment(UnsafeCasts.<UserPlayListFragment>unsafeCast(this));
    }
  }
}
