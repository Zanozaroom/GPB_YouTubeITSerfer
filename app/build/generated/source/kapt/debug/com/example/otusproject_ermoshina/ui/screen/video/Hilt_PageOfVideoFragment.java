 ...
 */
public abstract class Hilt_PageOfVideoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_PageOfVideoFragment() {
    super();
  }

  Hilt_PageOfVideoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PageOfVideoFragment_GeneratedInjector) this.generatedComponent()).injectPageOfVideoFragment(UnsafeCasts.<PageOfVideoFragment>unsafeCast(this));
    }
  }
