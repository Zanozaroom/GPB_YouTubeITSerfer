 ...
 */
public abstract class Hilt_FragmentMain extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentMain(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentMain_GeneratedInjector) this.generatedComponent()).injectFragmentMain(UnsafeCasts.<FragmentMain>unsafeCast(this));
    }
  }
