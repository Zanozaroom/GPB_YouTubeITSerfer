 ...
 */
public abstract class Hilt_YTPlayListFragment extends BasePLFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((YTPlayListFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectYTPlayListFragment(UnsafeCasts.<YTPlayListFragment>unsafeCast(this));
    }
  }
}
