 ...
 */
public abstract class Hilt_UserVideoFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UserVideoFragment() {
    super();
  }

  Hilt_UserVideoFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserVideoFragment_GeneratedInjector) this.generatedComponent()).injectUserVideoFragment(UnsafeCasts.<UserVideoFragment>unsafeCast(this));
    }
  }
